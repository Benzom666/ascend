...
const refactoredUserController = require("../controllers/v1/user.refactored");
...
/* get current user (me) - returns fresh user data including tokens */
router.get("/me", validateApi, userController.getMe);

router.get("/profile/:userId", validateApi, refactoredUserController.getProfile);
router.put("/profile", validateApi, refactoredUserController.updateProfile);
router.get("/stats", validateApi, refactoredUserController.getUserStats);
router.post("/change-password", validateApi, refactoredUserController.changePassword);
...
router.delete("/account", validateApi, userController.deleteAccount);
