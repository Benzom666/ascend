    ...
    switch (method) {
        ...
        case "send-request": {
            return [
                ...
                check("request_type")
                    .optional()
                    .isIn(["interested", "super_interested"])
                    .withMessage("request_type must be interested or super_interested"),
                validationResponse,
            ];
        }
        case "request-action": {
            return [
                check("request_id").not().isEmpty().withMessage("request_id is required.").bail(),
                validationResponse,
            ];
        }
        case "profile-info": {
