...
const seedDefaultMessage = [
    {
        ...
        profileUpdate: [
            "We observed that you attempted to quickly navigate through the profile creation process. To ensure the best user experience, please note that Ascend only grants entry to individuals with well-crafted profiles.",
        ],
    },
];
